...
export class MedusaChart {
    ...
    show() {
        ...
        if (this.displayMode === DisplayModes.stack) {
            ...
            this.ctx.lineTo(this.canvas.width, ay);
            this.ctx.stroke();
        }
    ...
    invertColor(hex, bw) {
        ...
        let rt = (255 - r).toString(16);
        let gt = (255 - g).toString(16);
        let bt = (255 - b).toString(16);
        // pad each with zeros and return
        return "#" + this.padZero(rt, 2) + this.padZero(gt, 2) + this.padZero(bt, 2);
    }
